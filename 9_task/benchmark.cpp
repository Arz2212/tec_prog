///
/// \file benchmark.cpp
/// \brief Сравнение производительности Quadtree vs std::vector.
///
/// Пункты 2 и 3 работы 9:
///   - Измерение времени вставки в Quadtree (C++)
///   - Измерение времени вставки в std::vector (оригинальный контейнер)
///   - Измерение времени поиска в радиусе (ключевая операция симуляции)
